<template>
  <el-dialog v-model="isShow" title="表单查询" width="620" :before-close="() => beforeClose(formQuery)">
    ...
    <template #footer>
      <div class="dialog-footer">
        ...
        <el-button @click="beforeClose(formQuery)" type="error">关闭</el-button>
      </div>
    </template>
  </el-dialog>
</template>
